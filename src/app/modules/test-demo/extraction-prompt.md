...
Write the spec to exactly this path: `src/app/modules/test-demo/SPEC.md`

IMPORTANT: Do NOT write the spec near the source component. The target module directory is `src/app/modules/test-demo/`, which is your current working directory. Write SPEC.md there and nowhere else.
