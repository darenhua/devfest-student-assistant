...
Write the spec to exactly this path: `src/app/modules/demo-stuff/SPEC.md`

IMPORTANT: Do NOT write the spec near the source component. The target module directory is `src/app/modules/demo-stuff/`, which is your current working directory. Write SPEC.md there and nowhere else.
