...
> how do we implement this notepad
...
Write the spec to exactly this path: `src/app/modules/second/SPEC.md`

IMPORTANT: Do NOT write the spec near the source component. The target module directory is `src/app/modules/second/`, which is your current working directory. Write SPEC.md there and nowhere else.
