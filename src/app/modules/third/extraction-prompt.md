...
- **File:** `/Users/lellyo/Desktop/cool-projects/devfest-school/web/src/app/modules/final/components/AgentDashboard.tsx`
...
1. Read the component at `/Users/lellyo/Desktop/cool-projects/devfest-school/web/src/app/modules/final/components/AgentDashboard.tsx` (starting around line `370`)
...
Write the spec to exactly this path: `src/app/modules/third/SPEC.md`

IMPORTANT: Do NOT write the spec near the source component. The target module directory is `src/app/modules/third/`, which is your current working directory. Write SPEC.md there and nowhere else.
